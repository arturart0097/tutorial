const GITHUB_LIGHT_THEME = {
  ...
  rules: [
    ...
    { foreground: "032f62", token: "string source" },
    { foreground: "005cc5", token: "string variable" },
    { foreground: "005cc5", token: "source.regexp" },
    { foreground: "005cc5", token: "string.regexp" },
    { foreground: "005cc5", token: "string.regexp.character-class" },
    {
      foreground: "005cc5",
    ...
    { foreground: "e36209", token: "markup.list" },
    ...
    { foreground: "005cc5", token: "markup.quote" },
    ...
    { foreground: "f6f8fa", background: "6a737d", token: "markup.ignored" },
    { foreground: "f6f8fa", background: "6a737d", token: "markup.untracked" },
    ...
    { foreground: "d73a49", token: "brackethighlighter.tag" },
    { foreground: "d73a49", token: "brackethighlighter.curly" },
    { foreground: "d73a49", token: "brackethighlighter.round" },
    { foreground: "d73a49", token: "brackethighlighter.square" },
    { foreground: "d73a49", token: "brackethighlighter.angle" },
    { foreground: "d73a49", token: "brackethighlighter.quote" },
  ...
  colors: {
    ...
    "editor.selectionBackground": "#c8defa",
    "editor.inactiveSelectionBackground": "#e1ecf9",
    "editor.lineHighlightBackground": "#f6f8fa",
    "editorCursor.foreground": "#24292e",
    "editorWhitespace.foreground": "#d0d7de",
    "editorIndentGuide.background": "#d0d7de",
    "editorIndentGuide.activeBackground": "#8c959f",
    "editor.selectionHighlightBorder": "#c8defa",
  },
};

export default GITHUB_LIGHT_THEME;
