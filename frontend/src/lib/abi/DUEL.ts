export const DUEL_ABI = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "rainAmount", type: "uint256" }],
    name: "convertRain",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address", name: "dynamicVesting", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "rainAmount", type: "uint256" },
      { internalType: "uint32", name: "stakePeriodDays", type: "uint32" },
    ],
    name: "swapAndStake",
    outputs: [],
    stateMutability: "nonpayable",
